...
const main = async () => {
    ...
    try {
        ...
        const report = await page.evaluate(() => {
            ...
            // The real double-render check: no baked twin of a currently
            // spawned placement may still be VISIBLE.
            const visibleMatchingSpawn = visibleBaked
        ...
        if (report.visibleMatchingSpawn !== 0) {
            failures.push(`${report.visibleMatchingSpawn} spawned placements still show their baked twin (double render)`);
        }
