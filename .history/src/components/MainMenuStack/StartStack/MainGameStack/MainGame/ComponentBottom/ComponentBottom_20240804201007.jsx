    ...
    return (
        <div className={styles.componentBottom}>
            <div className={styles.hammerButton}>
                <BottomIconComponent passiveIcon={images.hammer[0]} activeIcon={images.hammer[1]} type={'hammer'} />
            </div>
            <div className={styles.snapShotButton}>
                <BottomIconComponent passiveIcon={images.camera[0]} activeIcon={images.camera[1]} type={'camera'} />
            </div>
            <div className={styles.climateButton}>
                <BottomIconComponent passiveIcon={images.climate[0]} activeIcon={images.climate[1]} handleClimate={handleClimate} type={'climate'} />
            </div>
            ...
            <div className={styles.musicButton}>
                <BottomIconComponent passiveIcon={images.music[0]} activeIcon={images.music[1]} handleMusic={handleMusic} type={'music'}/>
            </div>
