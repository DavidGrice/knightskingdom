    ...
    return (
        <div className={styles.componentBottom}>
            ...
            <div className={styles.climateButton}>
                <BottomIconComponent passiveIcon={images.climate[0]} activeIcon={images.climate[1]} handleClimate={handleClimate} />
            </div>
            ...
            <div className={styles.musicButton}>
                <BottomIconComponent passiveIcon={images.music[0]} activeIcon={images.music[1]} handleMusic={handleMusic} />
            </div>
