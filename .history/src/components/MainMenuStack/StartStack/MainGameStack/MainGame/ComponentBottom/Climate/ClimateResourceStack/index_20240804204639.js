...
import ClearWeather5 from './cloudy_weather_5.png';
import DarkClearWeather2 from './dark_clear_weather_2.png';
import DarkClearWeather5 from './dark_cloudy_weather_5.png';
...
export const images = {
    clearWeather: [ClearWeather2, ClearWeather5],
    darkClearWeather: [DarkClearWeather2, DarkClearWeather5],
    darkDrizzlyWeather: [DarkDrizzlyWeather2, DarkDrizzlyWeather5],
    darkFoggyWeather: [DarkFoggyWeather2, DarkFoggyWeather5],
    darkThunderstormWeather: [DarkThunderstormWeather2, DarkThunderstormWeather5],
    darkWindyWeather: [DarkWindyWeather2, DarkWindyWeather5],
    drizzlyWeather: [DrizzlyWeather2, DrizzlyWeather5],
    foggyWeather: [FoggyWeather2, FoggyWeather5],
    thunderstormWeather: [ThunderstormWeather2, ThunderstormWeather5],
    windyWeather: [WindyWeather2, WindyWeather5],
    goCheckmark: [GoCheckmark2, GoCheckmark5]
};