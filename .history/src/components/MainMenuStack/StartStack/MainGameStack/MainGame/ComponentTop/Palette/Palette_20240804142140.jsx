...
const Palette = () => {
    ...
    // Generate an array of angles in degrees for 14 positions around a semi-circle
    const angles = Array.from({ length: numIcons }, (_, i) => (i * (180 / (numIcons - 1))));
    ...
    return (
      <div className={styles.paletteDiv}>
        {angles.map((angle, index) => {
          ...
          const y = centerY - radius * Math.sin(toRadians(angle)); // Adjust for semi-circle
          ...
          return (
            <img
              ...
              onClick={() => handleIconClick(index)} // Placeholder for click handler
            />
          );
        })}
      </div>
