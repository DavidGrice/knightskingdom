    ...
    return (
        <div className={styles.mainDiv}>
            <div className={styles.saveButton}>
                <TopIconComponent passiveIcon={leaveIcon.iconData.savePassive} activeIcon={iconData.saveActive} type='save' />
            </div>
            ...
            <div className={styles.driveAction}>
                <TopIconComponent passiveIcon={iconData.playPassive} activeIcon={iconData.playActive} type='play' />
            </div>
            <div className={styles.goodBye}>
                <IconComponent type={'leave'} placeholderImage={frames[0]} frames={leaveIcon.frames} />
            </div>
        </div>
    );
}
