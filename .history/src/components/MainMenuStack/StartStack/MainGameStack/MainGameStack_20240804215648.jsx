...
const MainGameStack = ({ navigateToStartMenu, map }) => {
    ...
    return (
        <Routes>
            ...
            <Route path="/game" element={<MainGame navigateToStartMenu={navigateToStartMenu} navigateToWorkshop={navigateToWorkshop} navigateToSnapshot={navigateToSnapshot} map={map} />} />
